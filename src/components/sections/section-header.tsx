...
export function SectionHeader({ sectionId, eyebrow, title, description }: SectionHeaderProps) {
  return (
    <Reveal as="header" className="mx-auto max-w-2xl space-y-3 text-center">
      ...
      <h2 id={`${sectionId}-heading`} className="font-heading text-h2 font-semibold tracking-tight">
        {title}
      </h2>
